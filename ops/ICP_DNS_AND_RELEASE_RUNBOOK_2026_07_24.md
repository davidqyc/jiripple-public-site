...
- 备案当前阶段：
  ...
  - 工信部短信核验：已核验
  - 管局审核：审核中
- 提交管局时间：`2026-07-25 10:25:02`
- 腾讯云页面推算：预计约 9 个工作日，最长不超过 20 个工作日；以实际管局结果为准
- DNS 当前仍由旧腾讯云账号管理；备案与 SCF 资源包在新公司账号下
- 管局审核期间订单已锁定，不支持撤回或修改；`www` CNAME 必须继续保持暂停
...
当前状态：工信部短信已核验，正在通信管理局审核；无需主动操作。
